...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#table_list").jqGrid({
            ...
            colModel: [
                ...
                {
                    name: 't_order_address.name',
                    index: 't_order_address.name',
                    align : "center",
                    width: 20
                },
                {
                    name: 't_order_address.phone',
                    index: 't_order_address.phone',
                    align : "center",
                    width: 20,
                },
                {
    ...
    $("#searchBtn").click(function(){
        ...
        $("#table_list").jqGrid('setGridParam',{
            url:"../order/list",
            postData:{order_id:order_id,eat_type:0,status:v_status}, //发送数据
            page:1
...
*/
    ...
    function searchStatus(status) {
        ...
        $("#table_list").jqGrid('setGridParam',{
            url:"../order/list",
            postData:{status:status,eat_type:0}, //发送数据
            page:1
        }).trigger("reloadGrid"); //重新载入
    }
    ...
    function toDetails(order_id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['90%', '90%'],
            content: '../order/toDetails?order_id='+order_id //iframe的url
        });
    }
