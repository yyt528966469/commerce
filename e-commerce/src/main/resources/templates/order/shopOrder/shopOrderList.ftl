    ...
    <div class="box-header">
      ...
      <ul id="nav_tabs" class="nav nav-tabs" >
          ...
          <#list orderStauteEnums as orderStaute>
               ...
               <li <#if orderStaute.index==2>class="active"</#if> ><a data-toggle="tab" onclick="searchStatus(${orderStaute.index})"
            ...
            colModel: [
                ...
                },
                {
                    ...
                    formatter: function(cellvalue,options,rowObject) {
                        ...
                        if(status==8){
                            v_result += " &nbsp; <a  class='a_click' style='width:65px;border:none; cursor: pointer;' onClick='returnApply(\"" + order_id + "\");'> 退款审核</a>";
                        }
                        return v_result;
                    }
                }
...
*/
   ...
   function returnApply(order_id){
       layer.open({
           ...
           shade: 0.8,
           area: ['90%', '90%'],
           content: '../order/returnApply?order_id='+order_id //iframe的url
       });
   }
