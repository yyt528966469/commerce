		...
		<div class="content">
			...
			<div class="content_right">
				<div class="content_login">
					<p class="dengl">登 录</p>
					<div class="log_input"><i> <img src="images/tubiao1.png" /> </i><input class="input" id="username" type="text" placeholder="请输入您的账号" /></div>
					<div class="log_input"><i> <img src="images/tubiao2.png" /> </i><input class="input"  id="password" type="password" placeholder="请输入密码" /></div>
					<h3><a href="#" >忘记密码?</a></h3>
					<br />
