        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
                <form id="myform">
                    ...
                    <input type="hidden" name="enterprise_id" value="${t_enterprise.enterprise_id!''}"/>

                    <div class="box-line">
                        <span class="title mid-inline-block">认证类型：</span>
                        <input class="long"  maxlength="10" aria-required="true" required=""  name="type"  value="${t_enterprise.type!'' }" placeholder="请输入店铺名称"/>
                    </div>
                    <div class="box-line">
                        <span class="title mid-inline-block">企业名称：</span>
                        <input class="long" maxlength="30" aria-required="true" required="" name="enterprise_name" value="${t_enterprise.enterprise_name!'' }" placeholder="请输入店铺简介"/>
                    </div>
                    <div class="box-line">
                        <span class="title mid-inline-block">店铺名称：</span>
                        <input class="long" maxlength="30" aria-required="true" required="" name="store_name" value="${t_enterprise.store_name!'' }" placeholder="请输入电话"/>
                    </div>
                    ...
                    <div class="box-line">
                        ...
                        <label for="cover" style="width: 30%;">
                            ...
                            <input type="hidden" id="img_src" name="certificates_img" value="${t_enterprise.certificates_img!''}">
                                    ...
                                    success:function(data){
                                        if(data.result=='0'){
                                            layer.alert("保存成功",function (index) {
                                                layer.close(index);
                                                window.location.href="../store/main";
                                            });
                            ...
                            var v_img_url = '${t_enterprise.certificates_img!""}';
