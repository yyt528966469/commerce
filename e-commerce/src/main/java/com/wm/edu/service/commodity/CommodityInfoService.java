...
public class CommodityInfoService {
    ...
    public Page<T_commodity_info> getInfoByComm_num(T_commodity_info t_commodity_info){
        Page<T_commodity_info> page=PageHelper.startPage(t_commodity_info.getPage(),t_commodity_info.getRows());
        t_commodity_infoMapper.getInfoByComm_num(t_commodity_info);
        return page;
    }
