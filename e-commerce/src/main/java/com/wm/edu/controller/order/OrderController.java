...
public class OrderController {
    ...
    @ResponseBody
    public Map<String,Object> returnMoney(String order_id){
        Map<String,Object> map=new HashMap<>();
        String res=orderService.returnMoney(order_id);
        map.put("result",res);
        return map;
    }
    @RequestMapping("/returnApply")
    public String returnApply(String order_id,Model model){
        T_order t_order=orderService.getOrderRetrunApply(order_id);
        model.addAttribute("t_order",t_order);
        return "order/shopOrder/returnApply";
    }
    @RequestMapping("/submitApplyInfo")
    @ResponseBody
    public Map<String,Object> submitApplyInfo(T_refund_apply t_refund_apply){
        Map<String,Object> map=new HashMap<>();
        String result=orderService.submitApplyInfo(t_refund_apply);
        map.put("result",result);
        map.put("t_refund_apply",t_refund_apply);
        return map;
    }
