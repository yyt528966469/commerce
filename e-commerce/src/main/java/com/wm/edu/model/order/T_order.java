...
public class T_order extends PageEntity {
    ...
    private T_refund_apply t_refund_apply;//
    ...
    public T_refund_apply getT_refund_apply() {
        return t_refund_apply;
    }

    public void setT_refund_apply(T_refund_apply t_refund_apply) {
        this.t_refund_apply = t_refund_apply;
    }
